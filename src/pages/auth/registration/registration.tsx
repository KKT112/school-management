...
const Registration = () => {
  ...
  const registrationUser = async () => {
    ...
    try {
      const res = await ApiRegister.postRegistration({
    ...
    <div className="">
      ...
      <div className="pt-20 relative">
        <div className="w-full relative">
          <img
            src={schoolRegistration}
            className="w-full xl:h-110 object-cover object-top"
          />
        </div>

        <p className="xl:text-4xl text-2xl font-bold text-center w-full pt-10">
          School Registration
        </p>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(Register)}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="pt-5 md:text-md">Password*</FormLabel>
                    <FormControl>
                      <Input
                        value={field.value}
                        onChange={field.onChange}
